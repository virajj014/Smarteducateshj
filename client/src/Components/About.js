    ...
    return (
        <div className="about-outer">
            ...
            <div className="abtus-head">
                <h1>About us</h1>
                <div>
                    <p><img className='img-2a' src={img2} />
                        ...
                        We deliver courses and bundles designed, created, and produced with real-world statistical data input for the folks we highly believe in.<img className='img-2b' src={img2} />
                    </p>
                </div>
            </div>
